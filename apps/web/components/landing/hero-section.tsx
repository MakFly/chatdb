    ...
    <section className="flex flex-col items-center justify-center px-6 py-36 text-center lg:py-44">
      ...
      <div className="mt-4">
        ...
        >
          ...
          <img
            src="https://img.shields.io/github/stars/YOUR_USERNAME/chatdb?style=social"
            alt="GitHub Stars"
          />
        </Link>
      </div>
      <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
        ...
        <Button asChild variant="outline" size="lg">
          <Link href="https://github.com/YOUR_USERNAME/chatdb" target="_blank" rel="noopener noreferrer">
            <Github />
            Voir sur GitHub
          </Link>
        </Button>
